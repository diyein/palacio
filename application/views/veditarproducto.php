            ...
            <div class="container p-4">
                <form id="form" method="POST" enctype="multipart/form-data" >
                    <div class="form-group">
                        ...
                        <input type="text" id="txtidentpr" name="txtidentpr" class="form-control" style="width:40%;"autocomplete="off" value="<?= (isset($detailproducto[0])) ? $detailproducto[0]->identpr : ""; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" >
                        ...
                        <input type="submit" id="btnenviar" class="btn btn-danger" name="btneliminar" style="margin-top:20px;width:15%;float:left;;margin-right:5%;" value="Eliminar">
                        <a href='/restaurante5/index.php/clistarproducto' class="btn btn-secondary" style="margin-top:20px;width:15%;float:left;margin-right:5%;">Cancelar</i></a>
